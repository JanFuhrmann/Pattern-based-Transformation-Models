...
> This node type installs, configures, and starts a Spring Backend of the RealWorldApplication.
> It can additionally connect to a MySQL 8 DB instead of the in-memory H2 DB.
